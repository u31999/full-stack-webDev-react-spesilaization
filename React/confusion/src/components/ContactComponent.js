...
const isNumer = (val) => !isNaN(Number(val));
            ...
            <div className="row row-content">
                ...
                <div className="col-12 col-sm-11 offset-sm-1">
                    <div className="btn-group" role="group">
                        ...
                        <a role="button" className="btn btn-info" href='https://twitter.com/'><i className="fa fa-skype"></i> Skype</a>
                            ...
                            <Col md={10}>
                                ...
                                validators={{
                                 ...
                                 show='touched' messages={{required: 'required',
                                                minLength: 'Must be greater than 2 charcter',
                                                maxLength: 'Must be 15 charcter or less'}}></Errors>
                            </Col>
                        </Row>
                        <Row className="form-group">
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                <Control.text model=".telnum" id='telnum' name='telnum' 
                                    ...
                                    validators={{
                                    required, minLength: minLength(10), maxLength: maxLength(10), isNumer 
                                }}
                                />
                                <Errors className='text-danger' model='.telnum' 
                                 show='touched' messages={{required: 'required',
                                                minLength: 'Tel number must be 10 numbers',
                                                maxLength: 'Tel number must be 10 numbers', 
                                                isNumer: 'Must be a number'}}></Errors>
                            </Col>
                        </Row>
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                ...
                                <Errors className='text-danger' model='.email' 
                                 show='touched' messages={{required: 'required',
                                                        validEmail:"Invalid email address"}}></Errors>
                            </Col>
                        </Row>
                        <Row className="form-group">
